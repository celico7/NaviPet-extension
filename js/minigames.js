...
class MinigamesController {
  constructor() {
    ...
    // État Memory
    this.MEMORY_EMOJIS = ['🐛','🦋','🌺','<img src="assets/sprites/minigames/star.png" style="width:36px;height:36px;image-rendering:pixelated;vertical-align:middle;">','<img src="assets/sprites/shop/pizza.png" style="width:36px;height:36px;image-rendering:pixelated;vertical-align:middle;">','<img src="assets/sprites/ui/arcade.png" style="width:36px;height:36px;image-rendering:pixelated;vertical-align:middle;">','<img src="assets/sprites/shop/fusee.png" style="width:36px;height:36px;image-rendering:pixelated;vertical-align:middle;">','💎'];
    this.memoryFlipped = [];
