...
export const SHOP_BACKGROUNDS = [
  ...
  { id: 'bg-beach',   name: 'Plage Ensoleillée', price: 100, icon: 'assets/sprites/shop/beach.png', extraHtml: '<div style="position:absolute;top:10px;right:10px;width:32px;height:32px;pointer-events:none;"><img src="assets/sprites/ui/sun.png" style="width:100%;height:100%;image-rendering:pixelated;vertical-align:top;"></div><div style="position:absolute;bottom:5px;left:15px;width:44px;height:44px;pointer-events:none;"><img src="assets/sprites/backgrounds/coquillage.png" style="width:100%;height:100%;image-rendering:pixelated;"></div><div style="position:absolute;bottom:5px;right:15px;width:48px;height:48px;pointer-events:none;"><img src="assets/sprites/backgrounds/crab.png" style="width:100%;height:100%;image-rendering:pixelated;"></div>' },
